...
def main():
    with open('assets/with_out_position_verification/first_cosine_values.txt', 'r', encoding='utf8') as source:
    ...
    with open('assets/with_out_position_verification/first_cosine_values_ranked.txt', 'w', encoding='utf8') as result:
        result.write('\n'.join(score_contents))
