...
def main():
    with open('assets/first_cosine_values_ranked.txt', 'r', encoding='utf8') as source:
    ...
    with open('assets/first_cosine_values_ranked_tagged.txt', 'w', encoding='utf8') as result:
        result.write('\n'.join(contents))
